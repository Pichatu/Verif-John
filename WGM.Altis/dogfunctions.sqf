...
if(playerSide != west) exitWith {}; //Seulement les policiers pourront avoir le chien.
...
_play  = (_this select 3) select 1;
_sound  = ["dog_one",_dog, 20] spawn _play;
hint "Rex viens que je te soigne !";
_unit setvariable ["follow",'false'];
_dog = _unit getvariable "dog";
...
{
_whistle = _unit addAction ["Au pied !", _dogWhistle, [_unit, _dogGrowl,_playSound,_dogReturnIdle,_dogVehicle]];
...
{
_follow = _unit addAction ["<t color = '#ffff00'>Suis-moi</t>", _dogFollow, [_unit,_playSound]];
...
_heel = _unit addAction ["<t color = '#ffff00'>Soigner</t>", _dogHeel, [_unit,_playSound]];
_unit setvariable ["step","wait"];
...
{
_stop = _unit addAction ["<t color = '#ff0000'>Plus bouger!</t>", _dogStop, [_unit,_playSound]];
_unit setvariable ["step","wait"];
