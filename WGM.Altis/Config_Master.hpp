...
class Life_Settings {
	...
	gang_price = 200000; //Price for creating a gang, remember they are persistent so keep it reasonable to avoid millions of gangs.
...
class Licenses {
	...
	LICENSEMACRO(legion,"STR_License_Legion","legion",100000000,false,"cop")
